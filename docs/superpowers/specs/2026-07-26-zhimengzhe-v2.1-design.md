...
- 默认显示最近游玩的 8 个游戏，超过时底部显示「查看全部」展开
- 「+ 新建」按钮始终可用，不限数量
...
| 方案 | 价格 | 说明 |
|------|------|------|
| 免费体验 | 0 元 | 20 轮 AI 对话（全局共享，走系统 Key） |
